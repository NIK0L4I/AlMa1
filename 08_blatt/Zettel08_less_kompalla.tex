...
\includegraphics[scale = 0.75, page=1]{AlMa_Zettel08.pdf}
\end{minipage}
\pagebreak
\begin{minipage}[t]{\textwidth}
\includegraphics[scale = 0.75, page=2]{AlMa_Zettel08.pdf}
\end{minipage}
\pagebreak
\begin{minipage}[t]{\textwidth}
\includegraphics[scale = 0.75, page=3]{AlMa_Zettel08.pdf}
\end{minipage}
\pagebreak
\begin{minipage}[t]{\textwidth}
\includegraphics[scale = 0.75, page=4]{AlMa_Zettel08.pdf}
\end{minipage}
\pagebreak
\begin{minipage}[t]{\textwidth}
\includegraphics[scale = 0.75, page=5]{AlMa_Zettel08.pdf}
\end{minipage}
\end{document}
%===================================== END DOCUMENT ====================================%